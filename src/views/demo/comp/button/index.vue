      ...
      <a-col :xl="14" :lg="24">
        <a-card title="BasicButton Types">
          ...
          <div class="my-2">
            ...
            <!--      <a-button.vue ghost type="link" class="ml-2"> link </a-button.vue>-->
            <!--      <a-button.vue ghost type="link" class="ml-2" loading> loading link </a-button.vue>-->
            <!--      <a-button.vue ghost type="link" class="ml-2" disabled> disabled link </a-button.vue>-->
          </div>
        </a-card>
      </a-col>
    </a-row>
